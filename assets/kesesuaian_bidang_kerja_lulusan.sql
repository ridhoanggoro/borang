...
CREATE TABLE `kesesuaian_bidang_kerja_lulusan` (
  ...
  `jml_lulusan_terlacak_rendah` int(10) NOT NULL,
  `jml_lulusan_terlacak_sedang` int(10) NOT NULL,
  `jml_lulusan_terlacak_tinggi` int(10) NOT NULL,
...
--
-- Indexes for table `kesesuaian_bidang_kerja_lulusan`
--
...
--
-- AUTO_INCREMENT for table `kesesuaian_bidang_kerja_lulusan`
--
ALTER TABLE `kesesuaian_bidang_kerja_lulusan`
