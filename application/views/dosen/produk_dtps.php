      ...
      success : function(data){
        ...
        for(i=0; i<data.length; i++){
          ...
          '<td style="text-align:right;">'+
              '<a href="javascript:void(0);" class="btn btn-info btn-circle btn-sm item_edit" data-toggle="tooltip" data-placement="top" title="Edit" data-seq_id="'+data[i].seq_id+'" data-nama_dosen="'+data[i].nama_dosen+'" data-nama_produk="'+data[i].nama_produk+'" data-deskripsi="'+data[i].deskripsi+'" data-bukti="'+data[i].bukti+'"><i class="fas fa-search"></i></a>'+' '+
