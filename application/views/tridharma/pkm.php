<div class="card shadow">
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
    ...
    <div class="float-right">
      ...
      <a href="<?php echo base_url('export/export_excel/'.encode_url('1-3'));?>" class="btn btn-success btn-icon-split btn-sm">
        <span class="icon text-white-50">
...
$(document).ready(function(){
  ...
  function show_data(){
    $.ajax({
      type  : 'ajax',
      url   : '<?php echo site_url('tridharma/pkm_data_list')?>',
      async : false,
      dataType : 'json',
    ...
    $('#upload').submit(function(e){
      e.preventDefault();
      $.ajax({
        url:'<?php echo site_url('upload/excel_upload/'.encode_url('1-3'))?>',
        type:"post",
  ...
  $('#btn_save').on('click',function(){
    ...
    $.ajax({
      type : "POST",
      url  : "<?php echo site_url('tridharma/pkm_add')?>",
      dataType : "JSON",
  ...
  $('#btn_update').on('click',function(){
    ...
    $.ajax({
      type : "POST",
      url  : "<?php echo site_url('tridharma/pkm_edit')?>",
      dataType : "JSON",
  ...
  //delete record to database
   $('#btn_delete').on('click',function(){
      ...
      $.ajax({
          type : "POST",
          url  : "<?php echo site_url('tridharma/pkm_delete')?>",
          dataType : "JSON",
          data : {seq_id:seq_id},
          success: function(data){
