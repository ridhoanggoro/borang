<div class="card shadow">
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
    ...
    <div class="float-right">
      ...
      <a href="<?php echo base_url('export/export_excel/'.encode_url('6a'));?>" class="btn btn-success btn-icon-split btn-sm">
        <span class="icon text-white-50">
      ...
      <div class="modal-body">
        <div class="form-row">
          <div class="form-group col-md-12">
            <label for="mitra">Upload Excel File, Klik <a href="<?php echo base_url('assets/upload/6.a.penelitian_dosen_mhs.xlsx');?>" data-toggle="tooltip" data-placement="top" title="Download Template">disini</a> untuk unduh file template</label>
...
$(document).ready(function(){
  ...
  function show_data(){
    $.ajax({
      type  : 'ajax',
      url   : '<?php echo site_url('penelitian/penelitian_dosen_dan_mhs_list')?>',
      async : false,
      dataType : 'json',
  ...
  $('#upload').submit(function(e){
    e.preventDefault();
      $.ajax({
        url:'<?php echo site_url('upload/excel_upload/'.encode_url('6.a'))?>',
        type:"post",
  ...
  $('#btn_save').on('click',function(){
    ...
    $.ajax({
      type : "POST",
      url  : "<?php echo site_url('penelitian/penelitian_dosen_dan_mhs_add')?>",
      dataType : "JSON",
  ...
  $('#submit').submit(function(e){
    e.preventDefault();
    $.ajax({
      url:'<?php echo site_url('penelitian/penelitian_dosen_dan_mhs_edit')?>',
      type:"post",
      data:new FormData(this),
      processData:false,
      contentType:false,
  ...
  //delete record to database
   $('#btn_delete').on('click',function(){
      ...
      $.ajax({
          type : "POST",
          url  : "<?php echo site_url('penelitian/penelitian_dosen_dan_mhs_delete')?>",
          dataType : "JSON",
          data : {seq_id:seq_id},
          success: function(data){
