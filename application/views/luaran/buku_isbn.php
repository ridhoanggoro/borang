<div class="card shadow">
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
    ...
    <div class="float-right">
      ...
      <a href="<?php echo base_url('export/export_excel/'.encode_url('8f4-4'));?>" class="btn btn-success btn-icon-split btn-sm">
        <span class="icon text-white-50">
      ...
      <div class="modal-body">
        <div class="form-row">
          <div class="form-group col-md-12">
            <label for="mitra">Upload Excel File, Klik <a href="<?php echo base_url('assets/upload/8.f.4-4.buku_isbn_mhs.xlsx');?>" data-toggle="tooltip" data-placement="top" title="Download Template">disini</a> untuk unduh file template</label>
      ...
      <div class="modal-body">
        <div class="form-row">
          ...
          <label for="luaran_penelitian">Luaran Penelitian dan PkM</label>
           <textarea class="form-control" rows="4" id="luaran_penelitian" name="luaran_penelitian" required></textarea>
          </div>
        </div>
        <div class="form-row">
      ...
      <div class="modal-body">
        ...
        <div class="form-row">
          ...
          <label for="luaran_penelitian_edit">Luaran Penelitian dan PkM</label>
           <textarea class="form-control" rows="4" id="luaran_penelitian_edit" name="luaran_penelitian_edit" required></textarea>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-4">
...
$(document).ready(function(){
  ...
  function show_data(){
    $.ajax({
      type  : 'ajax',
      url   : '<?php echo site_url('luaran/buku_isbn_mhs_data_list')?>',
      async : false,
      dataType : 'json',
  ...
  $('#upload').submit(function(e){
    e.preventDefault();
      $.ajax({
        url:'<?php echo site_url('upload/excel_upload/'.encode_url('8.f.4-4'))?>',
        type:"post",
  ...
  $('#btn_save').on('click',function(){
    ...
    $.ajax({
      type : "POST",
      url  : "<?php echo site_url('luaran/buku_isbn_mhs_add')?>",
      dataType : "JSON",
  ...
  $('#btn_update').on('click',function(){
    ...
    $.ajax({
      type : "POST",
      url  : "<?php echo site_url('luaran/buku_isbn_mhs_edit')?>",
      dataType : "JSON",
  ...
  //delete record to database
   $('#btn_delete').on('click',function(){
      ...
      $.ajax({
          type : "POST",
          url  : "<?php echo site_url('luaran/buku_isbn_mhs_delete')?>",
          dataType : "JSON",
          data : {seq_id:seq_id},
          success: function(data){
